...
from src.apps.common.database.utils import execute_and_fetchall, read_sql_file, execute_and_fetchone
...
def get_user_by_login(login) -> User | None:
    data = execute_and_fetchone('./SQL/select_user_by_login.sql', (login,))
